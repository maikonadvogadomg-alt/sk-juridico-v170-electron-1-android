...
import {
  ...
  Table as TableIcon, Plus, Trash2, ChevronDown, FileText,
} from "lucide-react";
...
export function TipTapEditor({
  ...
  return (
    <div className={cn("tiptap-editor-content flex flex-col border border-border rounded-lg overflow-hidden bg-card", className)}>
      {/* Toolbar */}
      {!readOnly && (
        <div className="flex flex-wrap items-center gap-0.5 px-2 py-1.5 border-b border-border bg-muted/50">
          ...
          <Button
            ...
            title="Reformatar todo o documento em padrão ABNT (justificado)"
          >
      ...
      {/* Área de edição */}
      <div
        className="flex-1 overflow-y-auto bg-card text-card-foreground"
      ...
      >
        <EditorContent
          ...
          className="min-h-full cursor-text prose prose-sm dark:prose-invert max-w-none
            ...
            [&_.ProseMirror_h1]:text-xl [&_.ProseMirror_h1]:font-bold [&_.ProseMirror_h1]:text-left [&_.ProseMirror_h1]:uppercase [&_.ProseMirror_h1]:tracking-wide [&_.ProseMirror_h1]:mt-4 [&_.ProseMirror_h1]:mb-2
            [&_.ProseMirror_h2]:text-base [&_.ProseMirror_h2]:font-bold [&_.ProseMirror_h2]:text-left [&_.ProseMirror_h2]:uppercase [&_.ProseMirror_h2]:mt-3 [&_.ProseMirror_h2]:mb-1
            [&_.ProseMirror_h3]:text-sm [&_.ProseMirror_h3]:font-semibold [&_.ProseMirror_h3]:text-left [&_.ProseMirror_h3]:mt-2 [&_.ProseMirror_h3]:mb-1
